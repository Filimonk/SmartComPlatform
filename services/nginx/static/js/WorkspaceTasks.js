...
class WorkspaceTasks {
    ...
    renderTasks() {
        ...
        if (this.tasks.length === 0) {
            this.tasksListContainer.innerHTML = '<div class="no-tasks"><svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="m648-426-46.67-47.33 130-101.34L480-770l-99.33 76.67-47.34-48L480-854.67l360 280L648-426Zm95.67 95.33-48-48 89-68.66L840-406l-96.33 75.33Zm73.66 262L638-248.67 480-126 120-406l55.33-41.33L480-210.67l110-85.66-47.67-47.34-62.33 49-360-280L227.67-659 67-818.33 114.67-866l750 750-47.34 47.33ZM491-583.33Z"/></svg><p>Список задач пуст</p></div>';
            return;
        }
        const now = new Date();
