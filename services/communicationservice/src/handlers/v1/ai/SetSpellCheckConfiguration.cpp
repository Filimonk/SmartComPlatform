#include "SetSpellCheckConfiguration.hpp"
...
SetSpellCheckConfiguration::SetSpellCheckConfiguration(const userver::components::ComponentConfig& config,
...
auto SetSpellCheckConfiguration::HandleRequestJsonThrow(const userver::server::http::HttpRequest& request,
    ...
    try {
        ...
        const auto request_dto = request_json.As<dto::SetSpellCheckConfigurationRequest>();

        const auto& result = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            communicationservice::sql::kSetSpellCheckConfiguration, user_id, request_dto.url, request_dto.timeout, request_dto.instruction);
