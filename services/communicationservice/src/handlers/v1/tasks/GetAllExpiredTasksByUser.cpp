#include "GetAllExpiredTasksByUser.hpp"
...
GetAllExpiredTasksByUser::GetAllExpiredTasksByUser(const userver::components::ComponentConfig& config,
...
auto GetAllExpiredTasksByUser::HandleRequestJsonThrow(
    ...
    try {
        ...
        const auto& result = pg_cluster_->Execute(
            ...
            communicationservice::sql::kGetAllExpiredTasksByUser, user_id);
        
        LOG_INFO() << "pg complited successfully";

        dto::GetAllExpiredTasksByUserResponse response;
        ...
        for (const auto& row : result) {
            ...
            response.tasks.push_back({contact_id, task});
        }
