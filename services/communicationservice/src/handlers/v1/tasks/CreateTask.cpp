...
CreateTask::CreateTask(const userver::components::ComponentConfig& config,
...
auto CreateTask::HandleRequestJsonThrow(const userver::server::http::HttpRequest& request,
    ...
    try {
        ...
        const auto request_dto = request_json.As<dto::CreateTaskRequest>();
        ...
        const auto& result = pg_cluster_->Execute(
            ...
            communicationservice::sql::kCreateTask, user_id, contact_id, request_dto.text,
            userver::storages::postgres::TimePointTz{request_dto.dueDate}, ToString(dto::TaskStatusType::kActive));
