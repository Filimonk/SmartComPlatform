...
GetSettings::GetSettings(const userver::components::ComponentConfig& config,
...
auto GetSettings::HandleRequestJsonThrow(const userver::server::http::HttpRequest& request,
    ...
    try {
        ...
        const auto& result = pg_cluster_->Execute(
            ...
            communicationservice::sql::kGetSettings, user_id);
        ...
        dto::GetSettingsResponse response;
        response.greeting_message = result[0]["greeting_message"].As<std::string>();
