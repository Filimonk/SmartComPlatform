...
UpdateSettings::UpdateSettings(const userver::components::ComponentConfig& config,
...
auto UpdateSettings::HandleRequestJsonThrow(const userver::server::http::HttpRequest& request,
    ...
    try {
        ...
        const auto request_dto = request_json.As<dto::UpdateSettingsRequest>();

        const auto& result = pg_cluster_->Execute(
            userver::storages::postgres::ClusterHostType::kMaster,
            communicationservice::sql::kUpdateSettings, user_id, request_dto.greeting_message);
