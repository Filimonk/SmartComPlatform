...
public:
    static constexpr std::string_view kName = "handler-v1-UpdateSettings";
    
    UpdateSettings(const userver::components::ComponentConfig&, const userver::components::ComponentContext&);
